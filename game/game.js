    ...
    document.addEventListener("keydown", (e) => {
        ...
        switch (e.key) {
            ...
            case "H":
                ...
                break;
            case "Enter":
                // reserved: restart on Game Over screen
                break;
            case " ":
                // reserved: combat action / continue
                e.preventDefault();
                break;
            // W/A/S/D reserved for labyrinth + reaction combat
        }
    });
}
...
function toggleHelp() {
    ...
    showOverlay(`
        <h2>❓ Steuerung</h2>
        <table>
            <tr><td>Maus-Klick</td><td>Entscheidung wählen / Angreifen</td></tr>
            <tr><td>1–9</td><td>Item aus Slot nutzen</td></tr>
            <tr><td>W A S D</td><td>Bewegen / Reaktionskampf</td></tr>
            <tr><td>Space</td><td>Aktion / Weiter</td></tr>
...
// ---- Kampf-Templates (Platzhalter für Tag 1/2) ----

function startWuerfelKampf(onWin, onLose) {
    // TODO Tag 1: D20 + Item-Bonus
    console.log("Würfelkampf startet...");
}

function startReaktionsKampf(onWin, onLose) {
    // TODO Tag 1: 3 Symbole, W/A/S in 1,5s
    console.log("Reaktionskampf startet...");
}

function startLabyrinth(onWin, onLose) {
    // TODO Tag 2: 2D-Grid, WASD, patrouillierende Zombies
    console.log("Labyrinth startet...");
}

function startBombenTiming(onWin, onLose) {
    // TODO Tag 2: Balken, Klick im grünen Bereich
    console.log("Bomben-Timing startet...");
}

function startStealth(onWin, onLose) {
    // TODO Tag 2: Aktions-Sequenz
    console.log("Stealth startet...");
}
