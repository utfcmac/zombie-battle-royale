...
function startBasketballAusweichen(onWin, onLose) {
    ...
    renderSceneImage("05_basketballplatz/assets/basketballplatz_kampf.png");
    combatArea.innerHTML = `
        ...
        <div class="bb-field">
            <img class="bb-zombie" src="05_basketballplatz/assets/sportlehrer.png" alt="">
            <img class="bb-player" src="05_basketballplatz/assets/ove_running.png" alt="">
        </div>
    `;
